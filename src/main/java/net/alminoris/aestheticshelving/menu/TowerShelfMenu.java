...
public class TowerShelfMenu extends AbstractContainerMenu {

    private final TowerShelfBlockEntity blockEntity;
    private final ContainerLevelAccess access;

    public TowerShelfMenu(int containerId, Inventory playerInventory, TowerShelfBlockEntity blockEntity)
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            for (int j = 0; j < 4; j++)
            {
                this.addSlot(new OneItemSlot(blockEntity, l++, 53+18*j, 26+18*i));
            }
        }

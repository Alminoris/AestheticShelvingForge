...
public class CeilingShelfScreen extends AbstractContainerScreen<CeilingShelfMenu>
{
    private final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(AestheticShelving.MOD_ID,
            "textures/gui/" + getWoodName(ModBlocks.CEILING_SHELVES, Objects.requireNonNull(menu.getSlot(0).container
                    instanceof CeilingShelfBlockEntity be ? be : null)) + ".png");

    public CeilingShelfScreen(CeilingShelfMenu menu, Inventory inventory, Component title)
    {

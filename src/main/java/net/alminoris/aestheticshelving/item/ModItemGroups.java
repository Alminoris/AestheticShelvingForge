...
{
    public static CreativeModeTab ASHELF_TAB;

    @SubscribeEvent
    public static void registerCreativeModeTabs(CreativeModeTabEvent.Register event)
    {
        ASHELF_TAB = event.registerCreativeModeTab(ResourceLocation.fromNamespaceAndPath(AestheticShelving.MOD_ID, "ashelftab"),
                builder -> builder.icon(() -> new ItemStack(ModBlocks.SHELVES.get("oak").get().asItem()))
